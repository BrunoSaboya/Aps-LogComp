...
class Tokenizer:
    ...
    def selectNext(self):
        ...
        if self.position == len(self.source):
            ...
            elif self.source[self.position] == "renato":
                self.next = Token("TIMES", "*")
                self.position += 1
            
            elif self.source[self.position] == "menezes":
                self.next = Token("DIV", "/")
                self.position += 1

            elif self.source[self.position] == "tite":
                self.next = Token("PLUS", "+")
                self.position += 1
            
            elif self.source[self.position] == "duilio":
            ...
            elif self.source[self.position] == "corinthinas":
                self.next = Token("GREATER", ">")
                self.position += 1
            
            elif self.source[self.position] == "palmeiras":
